...
#   06 main_figures        Fig 2, 3, 4, 5, 6 (r vs R RIS), Supp Fig 3, Supp S1
#   07 cutoff_sensitivity  O2_norm >= 0.5 sensitivity fits + dynamics PDFs
#   08 window_sensitivity  fit-window robustness of K, R, r (reviewer test)
#   09 montecarlo_N0       Monte-Carlo of R vs N0 uncertainty + figures
#   10 simulation_recovery synthetic parameter recovery (Fig S2)          [no inputs]
#   11 temperature_cue     temperature-response growth/resp/CUE (Fig 7)
#
...
# automatically without them. 11 uses its own input data/Oxygen_Data_Filtered_CUE.csv
# and is independent of 01-10.
#
...
for (s in c("01_longdata.R", "02_trimming.R", "05_oxygen_fits.R",
            "06_main_figures.R",
            "07_cutoff_sensitivity.R", "08_window_sensitivity.R",
            "09_montecarlo_N0.R", "10_simulation_recovery.R")) {
  run_script(s)
}
